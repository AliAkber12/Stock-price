...
st.markdown(f'<div class="footer">Made with ❤️ by Ali Akber<a href="{github_redirect_url}"><img src="{github_redirect_url}" width="30" height="30"></a>'
             f'<a href="{kaggle_redirect_url}"><img src="{kaggle_redirect_url}" width="30" height="30"></a>'
             f'<a href="{linkedin_redirect_url}"><img src="{linkedin_redirect_url}" width="30" height="30"></a></div>', unsafe_allow_html=True)